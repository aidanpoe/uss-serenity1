...
try {
    ...
    foreach ($competencies as $comp) {
        $formatted_competencies[] = [
            ...
            'status' => $comp['status'],
            'assigned_date' => $comp['assigned_date'], // Keep as-is since forms now submit IC dates
            'completion_date' => $comp['completion_date'], // Keep as-is since forms now submit IC dates
            'notes' => $comp['notes'],
