			...
			<div class="right-frame">
				...
				<main>
					...
					<div style="margin: 2rem 0;">
						...
						<p class="go-big" style="margin-top: 1rem;">View the source code for this portfolio on <a href="https://github.com/aidanpoe/uss-voyager" target="_blank" style="color: var(--gold); text-decoration: underline;">GitHub</a></p>
