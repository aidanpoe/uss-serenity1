						...
						<form method="POST" action="">
							<div class="form-grid">
								...
								<div class="form-group">
									...
									<input type="date" name="incident_date" id="incident_date" value="<?php echo isset($_POST['incident_date']) ? htmlspecialchars($_POST['incident_date']) : formatICDateOnly(date('Y-m-d')); ?>" required>
								</div>
